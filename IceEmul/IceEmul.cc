...
namespace daml {
  ...
  // -----------------------------------------------------------------------------
  IceEmul::IceEmul(const std::string infileName) :
  ...
  // -----------------------------------------------------------------------------
  void IceEmul::train(const torch::Tensor input, const torch::Tensor target) {
  ...
  std::tuple<torch::Tensor, torch::Tensor,
             std::vector<float>, std::vector<float>> IceEmul::prepData(std::string fileName, bool geoloc) {
  ...
  // -----------------------------------------------------------------------------
  void IceEmul::predict(std::string fileName, std::string fileNameResults) {
  ...
  int IceEmul::getSize(const std::string infileName, const std::string paramName) {
    eckit::PathName infilePathName = infileName;
    eckit::YAMLConfiguration config(infilePathName);
    int param;
