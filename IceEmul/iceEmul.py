...
f009 = Ice("gdas.t00z.icef009.ffnn.nc")
f003 = Ice("gdas.t00z.icef003.ffnn.nc")
f009.diff(f003)
...
#f009.scatterplot_ice(ax1, f009.aice, "$aice$", bounds=[0, 1])
...
#f009.scatterplot_ice(ax2, f009.aice_ffnn, "$aice_{ffnn}$", bounds=[0, 1])
...
f009.scatterplot_ice(ax3, f009.dcdt, "$dc/dT_{ocean}$", cmap='RdBu', bounds=[-0.3, 0.3])

# dcds
ax4 = fig.add_subplot(gs[1, 1], projection=projection)
f009.scatterplot_ice(ax4, f009.dcds, "$dc/dS_{ocean}$", cmap='RdBu', bounds=[-0.02, 0.02])

# dcdsi
ax = fig.add_subplot(gs[0, 2], projection=projection)
f009.scatterplot_ice(ax, f009.dcdsi, "$dc/dS_{ice}$", cmap='RdBu', bounds=[-0.05, 0.05])

# dcdhi
ax5 = fig.add_subplot(gs[1, 2], projection=projection)
f009.scatterplot_ice(ax5, f009.dcdhi, "$dc/dh_{ice}$", cmap='RdBu', bounds=[-3, 3])

# dcdhs
ax6 = fig.add_subplot(gs[2, 0], projection=projection)
f009.scatterplot_ice(ax6, f009.dcdhs, "$dc/dh_{snow}$", cmap='RdBu', bounds=[-3, 3])

# dcdtsfc
ax = fig.add_subplot(gs[2, 1], projection=projection)
f009.scatterplot_ice(ax, f009.dcdtsfc, "$dc/dT_{sfc}$", cmap='RdBu', bounds=[-0.1, 0.1])

# dcdtair
ax = fig.add_subplot(gs[2, 2], projection=projection)
f009.scatterplot_ice(ax, f009.dcdtair, "$dc/dT_{air}$", cmap='RdBu', bounds=[-0.05, 0.05])
